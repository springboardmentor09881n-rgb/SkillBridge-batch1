                    ...
                    <div className="flex flex-col gap-4 text-sm text-[var(--text-secondary)]" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                            ...
                            {organization?.website_url ? (
                                <a href={organization.website_url.startsWith('http') ? organization.website_url : `https://${organization.website_url}`} target="_blank" rel="noopener noreferrer" className="truncate hover:text-blue-600 cursor-pointer transition-colors" title={organization.website_url}>
